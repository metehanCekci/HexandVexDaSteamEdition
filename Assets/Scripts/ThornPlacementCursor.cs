...
/// <summary>
/// Thorn placement sırasında özel cursor gösterir.
/// cursorTexture alanına istediğiniz PNG'yi atın, hotspot otomatik ortalanır.
/// </summary>
public class ThornPlacementCursor : MonoBehaviour
{
    public static ThornPlacementCursor instance;

    [Header("Cursor Görseli (PNG atın)")]
    [Tooltip("Thorn placement sırasında görünecek ikon. İstediğiniz zaman değiştirin.")]
    ...
    void Update()
    {
        bool shouldBeActive = TurnManager.instance != null && TurnManager.instance.isThornPlacementTargeting;
